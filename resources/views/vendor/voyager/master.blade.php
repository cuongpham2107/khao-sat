...
<head>
    ...
    <script defer type="text/javascript" src="https://cdn3.devexpress.com/jslib/23.2.5/js/dx.all.js"></script>
...
<body class="dx-viewport voyager @if(isset($dataType) && isset($dataType->slug)){{ $dataType->slug }}@endif" >
