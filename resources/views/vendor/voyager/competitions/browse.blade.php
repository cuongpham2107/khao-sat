...
@section('content')
    @include('vendor.voyager.common.alert') 
                                            ...
                                            @foreach ($dataType->browseRows as $row)
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($row->type == 'rich_text_box')
                                                        @include('voyager::multilingual.input-hidden-bread-browse')
                                                        <div>
                                                            {{ mb_strlen(strip_tags($data->{$row->field}, '<b><i><u>')) > 200
    ...
    <div class="modal modal-danger fade" tabindex="-1" id="delete_modal" role="dialog">
     ...
     {{-- Single money modal --}}
     <div class="modal modal-danger fade" tabindex="-1" id="create_evaluations_modal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#65a30d">
                    <button type="button" class="close" data-dismiss="modal" aria-label="{{ __('voyager::generic.close') }}"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="voyager-edit"></i> Tạo đánh giá cho các đơn vị</h4>
                </div>
                <div class="modal-footer">
                    <form action="" id="create_evaluation" method="POST">
                        {{ csrf_field() }}
                        <label style="float: left; margin-bottom:15px">Bạn có chắc chắn muốn tạo mới đánh giá cho các đơn vị trong đợt thi đua này không</label>
                        <input type="submit" class="btn btn-sm btn-warning pull-right view" value="Xác nhận"> 
                    </form>
...
@section('javascript')
    ...
    <script>
        ...
        $('td').on('click', '.create-evaluations', function (e) {
            $('#create_evaluation')[0].action = '{{ route('voyager.create_evaluation','__id') }}'.replace('__id', $(this).data('id'));
